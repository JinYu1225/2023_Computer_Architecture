// This code is produced by yptang5488
// CLZ is only used in the first part of the algorithm in this code to
// find the starting point for the comparison of the two 64-bit parameter.
